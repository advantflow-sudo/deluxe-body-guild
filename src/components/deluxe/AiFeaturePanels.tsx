...
import {
  ...
  Trophy, Stethoscope, Flame, Users, Loader2,
} from "lucide-react";
...
export const FEATURES: { key: FeatureKey; title: string; sub: string; icon: typeof Sparkles; premium?: boolean; tier?: "essential" | "signature" }[] = [
...
export function FeaturePanel({ feature }: { feature: FeatureKey }) {
  switch (feature) {
