...
export const MEAL_PHOTOS: MealPhoto[] = [
  ...
  { id: "chicken-sweetpotato-avocado", url: chickenSweetPotatoAvocadoPeppers, visibleFoods: ["chicken", "potato", "avocado"], alt: "Sliced chicken breast with roasted sweet potato and avocado" },
  { id: "chicken-potato-peppers", url: chickenSweetPotatoAvocadoPeppers, visibleFoods: ["chicken", "potato", "pepper"], alt: "Sliced chicken breast with roasted sweet potato and peppers" },
  { id: "chicken-potato", url: chickenSweetPotatoAvocadoPeppers, visibleFoods: ["chicken", "potato"], alt: "Sliced chicken breast with roasted sweet potato" },
